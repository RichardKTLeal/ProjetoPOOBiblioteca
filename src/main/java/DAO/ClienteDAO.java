...
public class ClienteDAO {
    ...
    /*  Aqui nós temos a conexão do banco de dados com a tabela cliente do banco de dados e o método
    para a inserção de valores na tabela.
    */
    ...
    /*  Aqui nós temos o método de busca de valores de cada variável para o recebimento de valores pela tabela
   ...
   /*   Aqui nós temos o método de edição para atualização de cadastros
    ...
    */ 
    ...
    /*  Aqui nós temos o método de exclusão de valores da tabela cliente
